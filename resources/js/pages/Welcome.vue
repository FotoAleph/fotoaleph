            ...
            <div class="flex items-center gap-3">
                ...
                <div class="flex items-center gap-3 pr-3 border-r border-gray-300 dark:border-gray-700">
                    <div v-for="network in socialNetworks" :key="network.name">
                        <a :href="network.url" target="_blank" rel="noopener noreferrer" class="text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white transition-colors duration-300" v-html="network.icon">
                        </a>
                    </div>
                </div>
