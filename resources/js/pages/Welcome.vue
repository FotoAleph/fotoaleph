...
<template>
    ...
    <div class="min-h-screen relative bg-gray-50 text-gray-900 dark:bg-gray-900 dark:text-gray-100 font-sans selection:bg-green-500 selection:text-white pb-12 overflow-hidden">
        ...
        <header class="absolute top-0 right-0 p-6 w-full flex justify-end z-20">
            <nav class="flex items-center gap-4">
                <Link v-if="$page.props.auth?.user" :href="dashboard()"
                    class="px-4 py-2 rounded-md text-sm font-medium transition-colors hover:bg-gray-200 dark:hover:bg-gray-800 border border-transparent">
                    Dashboard
                </Link>
                <template v-else>
                    <Link :href="login()"
                        class="px-4 py-2 rounded-md text-sm font-medium transition-colors hover:bg-gray-200 dark:hover:bg-gray-800 border border-transparent z-20">
                        Log in
                    </Link>
                    <Link v-if="canRegister" :href="register()"
                        class="px-4 py-2 rounded-md text-sm font-medium bg-green-600 text-white hover:bg-green-700 transition-colors shadow-sm z-20">
                        Register
                    </Link>
                </template>
            </nav>
        ...
        <!-- Contenido Principal -->
        <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 flex flex-col items-center justify-center relative z-10">
            
            <!-- SECCIÓN HERO Y NUBE DE ETIQUETAS -->
            <section class="w-full mb-16 relative flex flex-col lg:flex-row items-center justify-between min-h-[50vh] lg:min-h-0">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8 w-full auto-rows-min">
            ...
            <article class="w-full mt-24 relative z-10">
            ...
            <section class="w-full mt-24 mb-32 relative z-10">
                <div class="bg-white dark:bg-gray-800 rounded-[2rem] p-10 md:p-16 text-center shadow-xl border border-gray-100 dark:border-gray-700 relative overflow-hidden group">
                    ...
                    <div class="relative z-10 max-w-2xl mx-auto">
                        ...
                        <div class="flex flex-col sm:flex-row justify-center items-center gap-4">
                            ...
                            <!-- Botón WhatsApp -->
                            <a href="https://wa.me/573132635848" target="_blank" rel="noopener noreferrer" class="w-full sm:w-auto px-8 py-3.5 bg-green-600 text-white font-bold rounded-xl shadow-md hover:bg-green-500 hover:-translate-y-1 hover:shadow-xl transition-all duration-300 flex items-center justify-center gap-2">
        ...
        <footer class="absolute bottom-0 w-full pb-6 text-center text-sm text-gray-600 dark:text-gray-400 z-10">
