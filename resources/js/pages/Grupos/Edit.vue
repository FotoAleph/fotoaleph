                ...
                <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                    <form @submit.prevent="submit" class="p-6 lg:p-8 bg-white border-b border-gray-200 space-y-4">
                        ...
                        <div class="flex justify-end gap-3">
                            <Link :href="route('grupos.index')" class="bg-gray-500 hover:bg-gray-700 text-white font-bold py-2 px-4 rounded">Cancelar</Link>
...
const form = useForm({
    ...
    nivel: props.grupo.nivel,
});

const submit = () => {
    form.put(route('grupos.update', { grupo: props.grupo.id }));
};
</script>
