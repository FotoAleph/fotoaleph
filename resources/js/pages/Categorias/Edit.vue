            ...
            <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                    <form @submit.prevent="submit" class="p-6 lg:p-8 bg-white border-b border-gray-200 space-y-4">
                        <h2 class="text-xl font-semibold text-gray-900">Editar categoría</h2>
...
const form = useForm({
    ...
    nivel: props.categoria.nivel,
});

const submit = () => {
    form.put(route('categorias.update', { categoria: props.categoria.id }));
};
</script>
